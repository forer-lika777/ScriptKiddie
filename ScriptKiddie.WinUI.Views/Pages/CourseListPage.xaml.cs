...
public sealed partial class CourseListPage : Page, IRecipient<RequestChooseSelectScheduleMessage>, IRecipient<TaskAddFailedMessage>, IRecipient<RequestConfirmWithdrawCourseMessage>
{
    ...
    public CourseListPage()
    {
        ...
        TabSelectorBar.Items.Add(new SelectorBarItem { Name = "TabBarItem1", Text = "选课列表", Tag = "selectable" });
        TabSelectorBar.Items.Add(new SelectorBarItem { Name = "TabBarItem2", Text = "已选课程", Tag = "selected" });
        TabSelectorBar.Items.Add(new SelectorBarItem { Name = "TabBarItem3", Text = "选课任务", Tag = "tasks" });
